 ...
 */
public class SortBy extends Text {

    private static final EnumSet<Type> MATCH_TYPES = EnumSet.of(Type.SORTBY, Type.TERM, Type.TEXT);

    public SortBy(String content, int at) {
        super(content, at);
    }
