...
public class Term extends Text {
    ...
    private static final EnumSet<Type> MATCH_TYPES = EnumSet.of(Type.TERM, Type.TEXT);
    private final String original;

    public Term(String content, int at) {
        this(content, content, at);
    }

    public Term(String original, String content, int at) {
        super(content, at);
