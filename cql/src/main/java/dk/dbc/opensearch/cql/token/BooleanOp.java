 ...
 */
public class BooleanOp extends Keyword {

    private static final EnumSet<Type> MATCH_TYPES = EnumSet.of(Type.BOOLEAN, Type.TERM, Type.TEXT);

    private final BooleanOpName op;

    public BooleanOp(BooleanOpName op, String content, int at) {
        super(content, at);
        this.op = op;
    }
    ...
    public String toString() {
        return "Token.BooleanOp{" + content + '}';
    }
}
