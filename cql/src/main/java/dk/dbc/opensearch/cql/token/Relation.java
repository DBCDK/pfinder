 ...
 */
public class Relation extends Keyword {

    private static final EnumSet<Type> MATCH_TYPES = EnumSet.of(Type.RELATION, Type.TERM, Type.TEXT);

    public Relation(String content, int at) {
        super(content, at);
    }
    ...
    public String toString() {
        return "Token.Relation{" + "name=" + getName() + '}';
    }
}
