...
public class Settings {
    ...
    *
    * Following fields are generated by validateAndProcess() ie. synthesized
    * from previous fields. NOT read from config file.
     */
    private DefaultPrefix defaultPrefix;
    ...
    public void validateAndProcess() {
        ...
        defaultPrefix = new DefaultPrefix(defaultNamespaces);
        if (jCache == null)
