...
public class OpenSearchResponseXML extends OpenSearchResponse {

    public OpenSearchResponseXML(Root.Scope<Root.EntryPoint> entryPoint) {
        super(entryPoint);
    }
