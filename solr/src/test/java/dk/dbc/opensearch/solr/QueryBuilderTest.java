...
public class QueryBuilderTest {
    ...
    public static List<Object[]> tests() throws Exception {
        SolrRules solrRules = solrRules("query-builder");
        return jsonTests("query-builder",
    ...
    public QueryBuilderTest(String name, String query, List<String> expected, String exception, SolrRules solrRules) {
        this.name = name;
        this.query = query;
    ...
    public void testCase() throws Exception {
        ...
        try {
            ...
            actual.add(QueryBuilder.queryFrom(flatQuery));
